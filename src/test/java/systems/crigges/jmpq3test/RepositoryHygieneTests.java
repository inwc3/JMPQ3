 ...
 * Merge conflict markers were once committed in documentation files. The build
 * stayed green throughout, because markdown is not compiled and passing tests
 * say nothing about it - so every check that was being run reported success on
 * a broken tree.
 * <p>
