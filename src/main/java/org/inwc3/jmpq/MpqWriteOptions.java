 ...
 *                        the file count. Use this when a caller needs a
...
public record MpqWriteOptions(
     ...
     * <p>
     * Exists so a caller can emit a maximised table without relying on the
     ...
     * <p>
     * Lets a caller reserve unused block table slots without adding placeholder
